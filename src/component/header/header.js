    ...
    <div>
      ...
      <div className="DAT_Header">
        <div className="DAT_Header-Menu">
          <button className="DAT_Header-Menu-Toggle" id = "Toggle" onClick={(e) => {pushSidebar(e)}}>
            <svg
      ...
      >
        ...
        <a className="DAT_Header-Notidropdown-Item">
          ...
          <div className="DAT_Header-Notidropdown-Item-Title">
            ...
            {/* Sua  */}A new monthly report is ready. Click here to view!
          </div>
        </a>
        {/* Item3  */}
        <a className="DAT_Header-Notidropdown-Item">
          ...
          <div className="DAT_Header-Notidropdown-Item-Title">
            ...
            {/* Sua  */}Critical system failure, systems shutting down.
          </div>
        </a>
        {/* Item4  */}
        <a className="DAT_Header-Notidropdown-Item">
          ...
          <div className="DAT_Header-Notidropdown-Item-Title">
            ...
            {/* Sua  */}New user request. Woody has requested access to the
            organization.
          </div>
        </a>
        {/* ViewAll  */}
        <a className="DAT_Header-Notidropdown-ViewAll">View All Alert</a>
      </div>
      {/* Message  */}
      <div
      ...
      >
        ...
        {/* Item2 */}
        <a className="DAT_Header-MessageDropdown-Item">
          <div className="DAT_Header-MessageDropdown-Item-Icon2" id="I1">
            <img
              class="dropdown-notifications-item-img"
        ...
        {/* Item3  */}
        <a className="DAT_Header-MessageDropdown-Item">
          <div className="DAT_Header-MessageDropdown-Item-Icon3" id="I1">
            <img
              class="dropdown-notifications-item-img"
        ...
        {/* Item4  */}
        <a className="DAT_Header-MessageDropdown-Item">
          <div className="DAT_Header-MessageDropdown-Item-Icon4" id="I1">
            <img
              class="dropdown-notifications-item-img"
        ...
        {/* ViewAll  */}
        <a className="DAT_Header-MessageDropdown-ViewAll">View All Alert</a>
      </div>
      {/* Users  */}
      <div
